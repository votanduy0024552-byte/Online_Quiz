...
CREATE TABLE IF NOT EXISTS chu_de (
    ...
    FOREIGN KEY (khoi_id) REFERENCES khoi_lop(id) ON DELETE CASCADE,
    UNIQUE KEY unique_chuде_mon (ten_chu_de, mon_id),
...
CREATE TABLE IF NOT EXISTS question_d2 (
    ...
    FOREIGN KEY (question_id) REFERENCES questions(id) ON DELETE CASCADE,
    CONSTRAINT chk_d2_answer CHECK (correct_answer REGEXP '^[ĐS]{4}\$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('admin', '\\\', 'Admin System', 'admin@example.com', '0123456789', '123456789', 'Nam', 'Admin', 'Active');

-- Users - Teachers
INSERT INTO users (username, password, full_name, email, phone, cccd, gender, role, status) VALUES
('teacher1', '\\\', 'Giáo Viên 1', 'teacher1@example.com', '0987654321', '987654321', 'Nam', 'Giáo viên', 'Active'),
('teacher2', '\\\', 'Giáo Viên 2', 'teacher2@example.com', '0912345678', '912345678', 'Nữ', 'Giáo viên', 'Active');

-- Users - Students
INSERT INTO users (username, password, full_name, email, phone, cccd, gender, role, status, date_of_birth) VALUES
('student1', '\\\', 'Học Sinh 1', 'student1@example.com', '0901234567', '901234567', 'Nam', 'Học sinh', 'Active', '2008-01-15'),
('student2', '\\\', 'Học Sinh 2', 'student2@example.com', '0902345678', '902345678', 'Nữ', 'Học sinh', 'Active', '2008-02-20'),
('student3', '\\\', 'Học Sinh 3', 'student3@example.com', '0903456789', '903456789', 'Nam', 'Học sinh', 'Pending', '2008-03-10');
